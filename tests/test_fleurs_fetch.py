...
def _worker_ok(_config: str, count: int, _streaming: bool, _data_file: Any, sink: Any) -> None:
    sink.put(("ok", [_row(i) for i in range(count)]))


def _worker_error(
    _config: str, _count: int, _streaming: bool, _data_file: Any, sink: Any
) -> None:
...
def _worker_silent(
    _config: str, _count: int, _streaming: bool, _data_file: Any, _sink: Any
) -> None:
